...
function GalleryCard({ item, onClick }: GalleryCardProps) {
  ...
  return (
    <div
      ...
      className={`relative w-full ${item.aspectRatio} overflow-hidden cursor-pointer bg-accent/25 border border-border/80 shadow-md hover:shadow-xl transition-all duration-300 rounded-none group mb-4`}
    >
