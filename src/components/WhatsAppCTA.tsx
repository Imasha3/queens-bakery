    ...
    <section className="py-12 md:py-16 bg-card border-y border-border transition-colors duration-300">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center space-y-6">
        ...
        <a
          ...
          className="inline-flex items-center gap-2.5 rounded-xl bg-emerald-500 text-white font-semibold px-8 py-3.5 shadow-md shadow-emerald-500/10 hover:bg-emerald-600 transition-all duration-300 hover:-translate-y-0.5 active:translate-y-0"
        >
